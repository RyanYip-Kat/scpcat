...
if __name__=="__main__":
  ...
  parser_dotplot.add_argument("--height",type=int,default=8,help="figure height")
  parser_dotplot.add_argument("--width",type=int,default=12,help="figure width")
  ...
  parser_embplot.add_argument("--genelist",type=str,default=None,help="gene list file,to show in embdding plot")
  parser_embplot.add_argument("--height",type=int,default=8,help="figure height")
  parser_embplot.add_argument("--width",type=int,default=12,help="figure width")
  ...
  parser_vln.add_argument("--height",type=int,default=8,help="figure height")
  parser_vln.add_argument("--width",type=int,default=12,help="figure width")
